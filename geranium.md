...
<param ve-image title="Illustrations of _Pelargonium odoratissimum_ and _Pelargonium inquinans_" url="https://www.biodiversitylibrary.org/pageimage/53144785" region="pct:55,40,30,30" attribution="Biodiversity Heritage Library">
<param ve-image title="Scarlet geranium" url="https://upload.wikimedia.org/wikipedia/commons/d/da/Scarlet_geranium.jpg" fit="cover" attribution="Wikimemdia Commons">
...
The essential oil extraction industry provides the base material for pharmaceutical and cosmetic production, among which is the perfume industry. The extraction of these oils is done by distillation and not taken directly, and the substances that evaporate and condense again come from the leaves, stems, roots, flowers, fruits and seeds. This natural extraction involves the creation of extensive crops, factories, and the hiring of high labor. In this way, the industry not only generates an international commercial network but also reorganizes and transforms the territory.
...
<param ve-map center="18, 40" zoom="2.5">
<param ve-map-layer geojson url="https://raw.githubusercontent.com/vmatallanachaves/plant-humanities/master/geojson/pelargonium.map.geojson" title="layer 1" active>
<param ve-map-layer geojson url="https://raw.githubusercontent.com/vmatallanachaves/plant-humanities/master/geojson/geranium.map.geojson" title="label 2" active>
...
<param ve-image
title="Shirley Hubberd’s Victorian garden plans, including bedding pelargoniums" url="https://www.biodiversitylibrary.org/pageimage/55342041" region="pct:10,10,90,90" attribution="Biodiversity Heritage Library">
