...
The first mention of peanuts in a Chinese text dates to 1503, a mere decade after Christopher Columbus’ “discovery” of the Americas. The manuscript describes boiled or cooked peanuts as “delicious” and gives the origin of its Chinese name 落花生 _luo hua sheng_ (commonly now just 花生 _hua sheng_), literally “born from a fallen flower,” which references how the peanut fruits below ground.[^11] Over the next centuries, peanuts spread inland from the trading ports of southern coastal cities. Though now ubiquitous in Chinese cuisine, peanuts were a luxury food served at banquets and out of reach for many until the nineteenth century. The peanut came to be imbued with new cultural meanings as well, as shown in this <span eid="Q8733">Qing Dynasty</span> agate carving depicting a pair of peanuts alongside red dates. The carving is a play on words: the characters for red date (枣, _zao_) and peanut (生, _sheng_), are homophones for the first two characters of the auspicious greeting 早生贵子 zao sheng gui zi, an encouragement for newlywed couples to soon have children.[^12]
