...
Through transregional trade networks wealthy Europeans obtained materials for cultivating sunflowers in medicinal and ornamental gardens and instructions for doing so.[^ref6] They also exchanged books, drawings, letters, and other communications, which contributed to the development of conventions for describing sunflowers through images and text. The model, at right, visualizes a network of physicians, herbalists, translators, publishers, artists, and patrons who were active in Europe, particularly in the Low Countries, between the 1550s and the 1570s. The Low Countries, then under the rule of Hapsburg Spain, became a leading center for print center where artists and woodblock carvers visual representations.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4NDAwNzI4MiwzOTE1NjYxMDEsLTIxNT
