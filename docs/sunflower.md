...
Through transregional trade networks wealthy Europeans obtained materials for cultivating sunflowers in medicinal and ornamental gardens and instructions for doing so.[^ref6] They also exchanged books, drawings, letters, and other communications, which established conventions for describing sunflowers through images and text. The model, at right, visualizes a network of physicians, herbalists, translators, publishers, artists, and patrons who were active in Europe, particularly in the Low Countries, between the 1550s and 1570s. The Low Countries, then under the rule of Hapsburg Spain, were a leading print center where artists and woodblock carvers embraced a naturalistic mode of representing plants in which they the quality of illustrations and their resemblance to actual specimens. That kind of precision became increasingly importance as the number of known plants dramatically grew as did the number of common names, in various languages, for identifying them.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA4NDU4MDYzMSw4MTg2MDI4ODMsMzkxNT
