...
Through transregional trade networks wealthy Europeans obtained materials for cultivating sunflowers in medicinal and ornamental gardens and instructions for doing so.[^ref6] They also exchanged books, drawings, letters, and other communications, which contributed to the development of conventions for describing sunflowers through images and text. Visual representations became increasingly important as the number of known plant expanded dramatically, from X to Y during the WHAT, a period when there was not a standardized approach to naming. Nor was there  The model, at right, visualizes a network of historical figures, including physicians, herbalists, translators, publishers, artists, and patrons, who were active in Europe between the 1550s and the 1570s. During that period, Flanders (present-day Belgium) was a leading print center 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDY4MzAyNTAsMzkxNTY2MTAxLC0yMT
