...
Charles-Louis L’Héritier de Brutelle first distinguished _Pelargonium_ as an independent genus in the late 1700s, though his work was overlooked at the time due to the reverence for Linnaean taxonomy.[^ref9] Although L’Héritier de Brutelle never published his taxonomic revisions, botanical illustrations prepared for his unrealized project by Pierre Joseph Redouté were published under the title _[Geraniologia](https://www.biodiversitylibrary.org/page/46555490)_. This one portrays _P. graveolens_, a rose-scented pelargonium that still bears L’Héritier de Brutelle’s name for it. Eventually, in the early-1800s, Robert Sweet introduced a serious classification system to ease the shortfall in Linnaean nomenclature. His five-volume book _[Geraniaceae](https://www.biodiversitylibrary.org/page/47461998)_ remains a vital source of information about the pelargonium.[^ref10] With more than 500 plant descriptions, it attests to the incredible popularity of the flower with a common name–“geranium”– then too deeply rooted in cultural imaginations to be corrected.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1ODY2MDIxNiwxMzE5ODU5NDEsLTEwND
