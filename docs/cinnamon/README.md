...
<param ve-image
	title="Image from 1720, showing the benefits that could be made from species circulation on temporary cleared fields (_chenas_). The image on the left shows "
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzg2OTAwODYzLDgxODkzNDY2NCwyNjk0MT
