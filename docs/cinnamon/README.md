...
<param ve-image
	title="Cinnamon, from a medieval Arabian manuscript of Dioscorides's _De Materia medica_ (first century CE). Translated in Arabic by an unknown scribe in Spain (twelfth-thirteenth century), and currently in the Bibliothèque Nationale de France, ms. Arabe 2850, f. 129b. [Note: I downloaded this image from HOLLIS Images. The image has a manifest but it is no reusable as it requires a login.]"
	url="18040817.jpg">
...
<param ve-image
	title="[I'm not sure if I want to use this image, and if so I should reproduce it as a proper ve-map tag, which seems like it would be a lot of work.]"
	url="Indian Ocean Spice route (Riddle 1985p99, from Miller 1969).jpg">
...
<param ve-image
	title="test"
	url="https://upload.wikimedia.org/wikipedia/commons/e/ef/AMH-5360-NA_Pieces_of_land%2C_a_half_hour_hence_from_Hangwelle.jpg"
	region="2184,997,950,713">
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY2NTA4MDcxNCw4MDcxMTg3NDIsLTE3MD
