...
<param ve-map-layer geojson active url="https://github.com/JSTOR-Labs/visual-essays/blob/master/docs/geojson/cities.json" date-field="inception" title="Cities">
