...
<param ve-map
	...
	title="Global distribution of cassava. Cassava’s native habitat is marked in green, and regions where cassava was introduced by humans are marked in purple."
<param ve-map-layer
	url="Cassava.json">
{#paragraph2}
