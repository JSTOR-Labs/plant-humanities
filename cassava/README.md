...
<param ve-map basemap="Esri_WorldPhysical" title="Pre-Columbian Andean civilizations: Nazca (magenta), Moche (purple), and Chimú (yellow)" center="-10.398459529701169, -75.35486070351776" marker-type="none" zoom="5" fill="none">
<param ve-map-layer geojson active url="Peru_Nazca_Moche_Chimor.json" show-label="true">
{#paragraph4}
